...
/*
 ...
 - main() 메서드가 실행되기전에 초기화되므로 main() 메서드 실행시 별도의 인스턴스 생성없이 변수를 사용할 수 있다.
...
public class E01StaticModifier {
	...
	public static void main(String[] args) {
		...
		/*
		 ...
		 어떤 인스턴스 변수로 접근하든 동일한 메모리가 된다. 따라서 값을 공유하게 되므로 동일한 결과를 출력하게된다.
		 */
//		ms1.staticVar = 800;
//		ms2.staticVar = 900;
		/*
		 따라서 위의 문장은 권장되지 않는다. 코드레벨에 보면 서로 다른 변수에 값을 할당하는것으로 보이기 때문이다.
		 아래 문장을 권장한다. 동일한 메모리에 값을 순차적으로 할당하는 것으로 보이기 때문이다.
		 */
