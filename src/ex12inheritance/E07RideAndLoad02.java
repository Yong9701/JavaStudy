...
public class E07RideAndLoad02 {
	...
	public static void main(String[] args) {
		...
		/*
		 정적메서드는 클래스명을 통해 호출한다. static의 기본규칙을 따르고 오버라이딩의 대상이 될수없다.
		 인스턴스 내부가 아닌 외부(Method영역)에 이미 로드되어 있는 상태이기 때문이다.
		 */
		DeChild.staticMethod();
		////////////////////////////////////////////////
		/*
		 부모타입의 참조변수를 통해 자식 인스턴스를 참조할 수 있다. 상속관계이므로 가능하다.
		 */
		...
		/*
		 ...
		 자식인스턴스가 생성될때 부모쪽의 메서드가 가려지게 되므로 참조변수의 영향을 전혀 받지 않는다.
		 */
		parent.excecise();
		parent.sleep();
		parent.printParent();
