...
//		float f4 = 3.14;
		...
		// float와 double의 연산은 큰 자료형인 double으로 반환된다.
		double d1 = 3.14;
		double d2 = f6 + d1;
		System.out.println("d2="+d2);
		
		/*
		 CPU는 실수의 계산에 기본적인 오차를 가지고있다. 이는 Jave의 문제가 아닌 컴퓨터의 태생적인 문제이므로 정확한 계산을 위해서는 약간의 보정을 필요로한다.
		 */
