...
public class E01JunsuType {
	...
	public static void main(String[] args) {
		/*
		 ...
		 -즉 정수형 변수를 사용할떄는 거의 대부분 int형을 사용하면 된다.
		 */
		...
		// 100/200의 결과는 0이 나오게 된다. Java에서는 정수와 정수의 연산결과로 정수가 반환된다. 만약 실수의 결과를 반환받고 싶다면 형반환(Type Casting)을 해야한다.
		result1 = int1 / int2;
		System.out.println("int1 + int2 = " + result1);
		...
		/* 
		 ...
		 - byte, short형은 게임캐릭터의 움직임이나 음원파일 등을 포현할 때 주로 사용된다.
		 */
		...
		/*
		 ...
		 이때 접미사(L 혹은 l)을 붙여서 int형 자료가 아닌 long형의 자료임을 컴파일러에게 알려줘야한다.
