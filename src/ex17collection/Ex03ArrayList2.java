...
public class Ex03ArrayList2 {
	...
	public static void main(String[] args) {
		 ...
		 */
		/*
		 메모리와 메모리가 연속정인 공간을 가지는 것이 아님, 개념적으로 연결되어있어서 링크드라고 함
		 확장이 굉장히 빠르다는 장점이 있으나 검색이 느리다는 단점을 지님
		 */
...
//		 ArrayList<Student> list2 = new ArrayList<Student>();
		...
		// List에 저장할 Student 인스턴스 생성. 외부 패키지에 선언되었으므로 import 후 생성해야한다.
		...
		for(int i=0; i<list2.size(); i++) {
			/*
			 ...
			 멤버변수값이 출력된다. 만약 오버라이딩이 되어있지 않다면 참조값이 출력될 것이다.
			 */
		...
		/*
		 시나리오] 컬렉션에 저장된 인스턴스를 이름으로 검색하여 삭제하는 코드를 성하시오.
		 	이 때 반복문은 확장for문을 사용하시오.
		 */
		...
		for(Student st : list2) {
			/*
			 ...
			 인스턴스에 저장된 name과 일치하는지 확인한 후 해당 인스턴스를 찾을 수 있다.
			 */
