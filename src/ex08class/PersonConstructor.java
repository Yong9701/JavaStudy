...
public class PersonConstructor {
	...
	/*
	 개발자가 생성자를 직접 정의하지 않으면 아래와 같이 매개변수와 실행부가 없는 디폴트 생성자가
	 컴파일러에 의해 자동으로 삽입된다.
	 지금까지 인스턴스 생성시 new 클래스명()과 같이 사용했던 문장이 바로 디폴트 생성자를 호출하는 것이었다.
	 */
	...
	void initialize(String name, int age, String addr) {
		/*
		 ...
		 하지만 멤버메서드는 개발자가 원할때 언제든 호출이 가능하므로 생성자와는 특성이 다르다.
