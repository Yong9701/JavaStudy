...
/*
 ...
 메인쓰레드가 종료되도 계쏙 실행되며, Dead 상태가 되어야만 실행이 종료되는 쓰레드를 말한다.
...
class NormalThread extends Thread {
	...
	/*
	 쓰레드 동작중 비정상적으로 종료될 때 InterruptedException이
...
/*
 ...
 프로그램이 종료될 때 함께 종료되므로 주로 무한루프로 구성된다.
 */
class DaemonThread extends Thread {
	/*
	 무한루프로 구성되어있고 별도의 탈출조건을 만들지 않는다.
	 3초에 한번씩 block 상태로 들어가게 구현되어있다.
	 */
	@Override
	public void run() {
		while(true) {
...
public class Ex03DaemonThread {
	...
	public static void main(String[] args) {
		...
		/*
		 ...
		 5로 지정된다. 쓰레드 인스턴스 생성시 이름을 부여하는 방법으로 아래 두가지가 있다.
		 */
