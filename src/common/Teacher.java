...
public class Teacher extends Person {
	...
	/*
	 시나리오] Teacher객체는 나이와 과목이 같으면 동일한 객체로 처리하도록 hashCode와 equlas 메서드를
	 적절히 오버라이딩 하시오.
	 */
	/*
	 hashCode()
	...
	public int hashCode() {
		...
		System.out.print("returnCode1="+ returnCode1);
		
		/*
		 방법2 : 방법1이 번거롭다면 Object 클래스의 정적메서드인 hash()를 사용해도된다.
		 		멤버변수의 갯수만큼 인수로 전달하면 위와 동일하게 고유한 주소값을 정수형으로
		 		반환해준다.
		 */
		int returnCode2 = Objects.hash(super.getAge(), this.subject);
		System.out.print(" returnCode2="+ returnCode2);
		System.out.println();
	...
	/*
	 equlas() : 인스턴스가 가진 멤버변수의 값을 비교한다. 값이 같을때는 true 다를때는
	 			false를 반환하도록 오버라이딩 하면된다.
	 */
	@Override
	public boolean equals(Object obj) {
		...
		/*
		 ...
		 subject는 String이므로 equlas() 메서드를 통해 비교해야한다.
		 */
