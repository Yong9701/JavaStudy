...
public class E02ArrayAndMethod {
	...
	public static void main(String[] args) {
		...
		/*
		 배열명을 출력하면 메모리의 주소값이 문자열형태로 출력된다. 즉 배열명은 배열에 저장된 값 자체가 아닌
		 Heap영역에 생성된 메모리의 주소값을 저장하게 된다.
		 */
		...
		/*
		 main에서 생성했던 배열객체의 참조값을 매개변수로 넘기고, 다시 반환받았으므로 결국 동일한 배열을 참조하게되어
	...
	/*
	 매개변수로 전달된 배열의 참조값을 ar로 받게 되므로 해당 메서드에서도 동일한 배열을 참조할 수 있게된다.
