...
public class E01If03 {
	...
	public static void main(String[] args) {
		/*
 		  시나리오] 국, 영, 수 점수의 평균값을 구하여 학점을 출력하는 프로그램을 작성하시오. 90점이상은 A학점...
 		 		  60점 미만은 F학점을 출력하면 된다.
		 */
		// 점수는 정수타입으로 할당
		int kor=99, eng=70, math=64;
		/*
		 펑균값은 소수점이 나올수 있으므로 실수형으로 선언하는 것이 좋다.
		...
		/*
		앞에서 작성한 if문에서 조건의 순서만 변경되었지만, 60점 이상이라는 조건에 만족하기 때문에 높은 점수라도 모두 D학점이 출력된다.
