...
public class E05For {
	...
	public static void main(String[] args) {
		...
		/*
		 for문의 초기식에서 선언된 변수 j는 for문이 종료된느 순간 메모리에서 소멸된다. 여기서 사용된 변수 j는 지역변수(Local variable)라고 한다.
...
//		System.out.println("위 for문에서 선언한 변수 j= "+ j);
		...
		/*
		 for문의 초기값을 외부(넓은지역, 여기서는 main메서드 지역)에서 선언하면 해당변수는 for문의 안쪽(좁은지역)에서 사용할 수 있다.
		 즉 아래에 선언한 변수i는 main메서드의 지역번수로 선언된다.
		 */
		int i=0;
		for(; i<=5; i++) {
