...
/*
 ...
 해당 클래스는 추상메서드를 포함하고 있으므로 하위에서 상속받으면 반드시 추상메서드를 오버라이딩 해야한다.
 */
...
/*
DTO(Date Transfer Object) : 데이터를 저장하고 전송하기 위한 용도의 객체를 말한다.
...
class PersonalInfoDTO {
	...
	/*
	 getter/setter 메서드 정의 : private으로 정의된 멤버변수를 설정하거나 값을 반환받기 위해 생성함
	 */
